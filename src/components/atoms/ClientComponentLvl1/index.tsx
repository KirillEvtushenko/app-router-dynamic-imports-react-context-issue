...
import { Icon } from "@/components/registry"

const ClientComponentLvl1: React.FC = () => {

  return (
    <div className="m-12 p-4 border border-red-800 bg-red-200 rounded-xl">
      <h1 className="font-bold text-xl mb-6">Client Component LVL1. CLS is there as icons have their own dynamic registry</h1>
